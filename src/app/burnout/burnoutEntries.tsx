...
export const burnoutEntries: BurnoutEntry[] = [
    ...
    // {
    //     id: "3",
    //     content: "If they act like they don't care about you, believe them.",
    // },
    // {
    //     id: "4",
...

    {
        ...
        But to wait when you know the person will not come — that is your love.

        People say you should never expect anything in return from anyone. But the truth is, when we truly love someone, we naturally expect a little care and love in return.
